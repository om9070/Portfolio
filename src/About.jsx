        ...
        <>
            ...
            <div className=' container my-5'>
                ...
                <div>
                    ...
                    <div className="progress my-3">
                        <div className="progress-bar bg-info progress-bar-striped" role="progressbar" style={{ width: "65%" }} aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">65%</div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="progress my-3">
                        <div className="progress-bar bg-danger progress-bar-striped" role="progressbar" style={{ width: "75%" }} aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">75%</div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="progress my-3">
                        <div className="progress-bar progress-bar-striped" role="progressbar" style={{ width: "60%" }} aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">60%</div>
                    </div>
                </div>
            ...
            <div className='row container my-5 mx-auto'>
                <div className=" col-sm-6 my-2">
                    ...
                    <h3 className='fuffa'>Fronted side</h3>
                ...
                <div className=" col-sm-6 my-2">
                    ...
                    <h3 className='fuffa'>Backed side</h3>
